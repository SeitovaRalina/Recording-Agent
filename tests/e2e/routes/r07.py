...
def body(ctx: RouteCtx) -> None:
    ...
    ctx.say(
        ...
        expected=(
            "Каталог G4: вопросы по записям не тронуты (без answer/route-interview). Мила может "
            "ответить на посторонний вопрос своими средствами (у неё есть и другие навыки) или "
            "вежливо отказать; желательно одной строкой напомнить об открытых вопросах."
        ),
    )
